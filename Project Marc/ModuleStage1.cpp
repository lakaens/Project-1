...
bool ModuleStage1::Start() {
	...
	/*App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERRIGHT, 7, -2381);
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERLEFT, 212, -2095);
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERLEFT, 210, -1938);
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERLEFT, 211, -1426);
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERRIGHT, 5, -1258);
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERRIGHT, 4, -1065);
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERRIGHT, 4, -809);
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERLEFT, 212, -337);
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERLEFT, 204, -152);*/
	App->enemies->AddEnemy(ENEMY_TYPES::WINDOWSNIPERLEFT, 9, -84);
